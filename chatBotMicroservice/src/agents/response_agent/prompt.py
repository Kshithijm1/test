RESPONSE_AGENT_BASE_PROMPT = (
    ...
    "CRITICAL: If a Data Summary section is provided below with retrieved rows, the data IS AVAILABLE. "
    "NEVER say the data is unavailable, missing, or not accessible when a Data Summary is present. "
    "Use the data in the Data Summary to answer the user's question.\n"
